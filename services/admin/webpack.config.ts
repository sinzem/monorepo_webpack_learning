...
export default (env: EnvVariables) => { 
    ...
    config.plugins.push(new webpack.container.ModuleFederationPlugin({ /* (настройки подключения микрофронтенда - admin, как отдельного приложения) */
      name: 'admin', /* (имя приложения) */
